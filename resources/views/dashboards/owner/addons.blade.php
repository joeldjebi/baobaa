<x-dashboards.owner-shell title="Modules complémentaires" subtitle="Pilotez les options vendables : sonorisation, mobilier, traiteur, sécurité ou services premium." active="addons" :owner-profile="$ownerProfile" :active-venues-count="$activeVenuesCount" :pending-bookings-count="$pendingBookingsCount" :confirmed-bookings-count="$confirmedBookingsCount" :gross-revenue="$grossRevenue" :active-subscription="$activeSubscription" :billing-preference-label="$billingPreferenceLabel">
