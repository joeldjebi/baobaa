...
class ServiceProviderRegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        ServiceProviderProfile::query()->create([
            'user_id' => $user->id,
        ...
        PortalAccessRequest::query()->create([
            'user_id' => $user->id,
            'requested_role' => UserRole::ServiceProvider,
            'status' => 'pending',
        ...
        return redirect()->route('client.dashboard')->with('portal_status', 'Votre dossier prestataire événementiel est en cours de validation par le SAP.');
    }
}
